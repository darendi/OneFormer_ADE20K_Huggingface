...
image_folder = '/home/darendy/OneFormer_ADE20K/images'
segmentation_folder = '/home/darendy/OneFormer_ADE20K/segmented_images'

# Create an output folder to store the overlaid images
output_folder = '/home/darendy/OneFormer_ADE20K/overlay_images'
...
for image_name in os.listdir(image_folder):
    ...
    alpha = 0.4  # Adjust the alpha value for desired transparency

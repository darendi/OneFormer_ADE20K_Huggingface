...
folder_path = '/home/darendy/OneFormer_ADE20K/segmented_images'

# Path to the JSON file containing class labels and colors
json_file = '/home/darendy/OneFormer_ADE20K/objectName150_colors150.json'

# Output folder for saving the images with legends
output_folder = '/home/darendy/OneFormer_ADE20K/images_w_legend/segmented_images'

# Load the class labels and colors from the JSON file
with open(json_file, 'r') as file:
    data = json.load(file)
    class_labels = {tuple(label['color']): label['name'] for label in data['labels']}
